...
/*SPI Order */
#define SPI_u8_DATA_MSB   0
#define SPI_u8_DATA_LSB   1
/*CLK Phase*/
#define   SPI_u8_Sample_Setup   0
#define   SPI_u8_Setup_Sample    1
/*CLK Polarity*/
#define   SPI_u8_Falling_Rising   0
#define   SPI_u8_Rising_Falling    1
