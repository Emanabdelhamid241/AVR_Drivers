...
//	ES_t Local_enu_Erorr_State= ES_OK;
	...
	/*Choose data order */
#if SPI_u8_DATA_Order == SPI_u8_DATA_MSB
	CLR_BIT(SPI_u8_SPCR_REG,SPI_u8_DORD_BIT5);
#elif SPI_u8_DATA_Order  == SPI_u8_DATA_LSB
	SET_BIT(SPI_u8_SPCR_REG,SPI_u8_DORD_BIT5);
#endif

	/* CHOOSE Clk  Polarity */
#if SPI_u8_CLK_Polarity == SPI_u8_Falling_Rising
	SET_BIT(SPI_u8_SPCR_REG,SPI_u8_CPOL_BIT3);
#elif SPI_u8_CLK_Prirte  == SPI_u8_DATA_LSB
	CLR_BIT(SPI_u8_SPCR_REG,SPI_u8_CPOL_BIT3);
#endif

	/* CHOOSE Clk Phase */
#if SPI_u8_CLK_Phase == SPI_u8_Setup_Sample
	SET_BIT(SPI_u8_SPCR_REG,SPI_u8_CPHA_BIT2);
#elif  SPI_u8_CLK_Phase == SPI_u8_Sample_Setup
	CLR_BIT(SPI_u8_SPCR_REG,SPI_u8_CPHA_BIT2);
#endif
